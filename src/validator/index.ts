...
export class PositiveIntegerValidator extends WangValidaotr {
...
export class RegisterValidator extends WangValidaotr {
  constructor(ctx: Context) {
    super(ctx)
...
export class TokenValidator extends WangValidaotr {
  constructor(ctx: Context) {
    super(ctx)
    // type 登录方式
    this.type = [
    ...
    // account
    this.account = [
      {required: true, message: '不符合账号规则', min: 4, max: 32}
    ]
